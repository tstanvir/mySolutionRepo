...
#define preci cout<<fixed<<setprecision(16);
...
void solve(){
    ...
    double ans=0;
    int i=0,j=n-1;
    double pos1=0,pos2=l,speed1=1,speed2=1,t1=0,t2=0;
    while(i<=j){
    	double d1=vec[i]-pos1;
    	double d2=pos2-vec[j];
    	t1=d1/speed1;
    	t2=d2/speed2;
    	if(t2>t1){
    		pos1=vec[i];
