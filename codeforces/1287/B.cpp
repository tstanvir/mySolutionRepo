...
void solve(){
    ...
    rep(i,n){
    	rep1(j,i+1,n-1){
    		string tmp="";
    		rep(_,k){
    			if(prime[i][_]==prime[j][_]) tmp+=prime[i][_];
    			else {
    				if(prime[i][_]=='S' and prime[j][_]=='T') tmp+="E";
    				else if(prime[i][_]=='E' and prime[j][_]=='T') tmp+="S";
    				else if(prime[i][_]=='S' and prime[j][_]=='E') tmp+="T";
    				else if(prime[i][_]=='E' and prime[j][_]=='S') tmp+="T";
    				else if(prime[i][_]=='T' and prime[j][_]=='S') tmp+="E";
    				else tmp+="S";
    			}
    		}
