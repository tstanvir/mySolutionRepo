...
void solve(){
    ...
    ll ans1=Bigmod(10ll,n,MOD),ans2=(Bigmod(9ll,n,MOD)%MOD+Bigmod(9ll,n,MOD)%MOD)%MOD;
    ll ans=((ans1%MOD-ans2%MOD)+MOD)%MOD;
    ans=(ans%MOD+Bigmod(8ll,n,MOD)%MOD)%MOD;
    cout<<ans<<endl;
}
